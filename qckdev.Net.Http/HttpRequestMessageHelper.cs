...
namespace qckdev.Net.Http
{
    static class HttpRequestMessageHelper
    {
        ...
        public static Task<FetchFailedException<TError>> CreateExceptionAsync<TError>(HttpRequestMessage request, HttpStatusCode? statusCode, DeserializationHelper.ErrorHandleResponse<TError> errorDetails, Exception innerException = null, CancellationToken cancellationToken = default)
            => CreateExceptionAsync(request, statusCode, errorDetails.ReasonPhrase, errorDetails.ContentString, errorDetails.Content, innerException, cancellationToken);

        public static async Task<FetchFailedException<TError>> CreateExceptionAsync<TError>(HttpRequestMessage request, HttpStatusCode? statusCode, string message, string contentString, TError content, Exception innerException = null, CancellationToken cancellationToken = default)
        {
